...
## Design Patterns designPatterns.pdf (Max 12 marks)
  ...
  - Design Patterns (max 3 marks)
    ...
    **Missing explanations for why Strategy and Observer patterns are being used.**
    **Missing written details as to how Command, Observer, and Strategy will be implemented**
    **Proxy pattern explanation is unclear**
  ...
  - UML Diagrams (max 5 marks)
    ...
    Your Mark: 4.5
   **Proxy pattern UML unclear as to where pattern is being used**
  ...
  - Writing (max 2 marks) 
    ...
    Your Mark: 1
    **Explanations have some grammatical errors**
  
  Design Patterns Total Mark: 9.5/ 12
...
---
## Total Mark  
Sprint 0 Total Mark :  19.5/ 22
	
## Notes
-I think you have a idea for Proxy pattern, but you did not explain it very well in the report.
